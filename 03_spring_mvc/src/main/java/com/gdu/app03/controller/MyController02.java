...
public class MyController02 {
  ...
  // /member/list    요청을 /member.list.jsp 경로로 인식한다. (suffix값 .do는 안 붙여도 상관없다. Jsp servlet에서 먼저 나온 개념이라 관습처럼 주소를 구분하기 위해 사용된다.)
  @GetMapping(value="/member/list.do")
  public void memberList() {  
    
  }
  // void(반환타입이 없는 경우)는 1차로 서비스에서 경로를 찾으려고 하고 
  // 서비스가 없는 경우 주소를 Jsp경로로 바꿔서 인식한다.    
