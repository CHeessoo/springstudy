...
public class MainWrapper {
  ...
  public static void ex02() {
    ...
    // com.gdu.app01.anno01 패키지에 정의된 bean을 생성
    AbstractApplicationContext ctx = new AnnotationConfigApplicationContext("com.gdu.app01.anno01");  // config 파일이 여러개일 때 유용한 방법
