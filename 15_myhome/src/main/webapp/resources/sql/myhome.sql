...
INSERT INTO ACCESS_T VALUES('user1@naver.com', SYSDATE);  -- 로그인 정보가 일치할 때 접속기록 저장
COMMIT;
...
-- 3. 휴면 처리 할 때 (12개월 이상 로그인 이력이 없다. 로그인 이력이 전혀 없는 사용자 중에서 가입일이 12개월이 이상 지났다.)
INSERT INTO INACTIVE_USER_T -- SELECT로 가져온 결과를 INSERT 할 땐 VALUES가 원래 없다.
(
...
INSERT INTO ACCESS_T VALUES('user2@naver.com', SYSDATE);  -- 휴면 해제 후 로그인 기록 남기기
COMMIT;
