...
public class MyPageUtils {
  ...
  public String getMvcPaging(String url, String param) {
    ...
    if(beginPage == 1) {
      ...
      sb.append("<a href=\"" + url + "?page=" + (beginPage - 1) + "&" + param + "\">이전</a>");
    }
    ...
    for(int p = beginPage; p <= endPage; p++) {
      if(p == page) {
        ...
        sb.append("<a href=\"" + url + "?page=" + p + "&" + param + "\">" + p + "</a>");
      }
    }
    ...
    if(endPage == totalPage) {
      ...
      sb.append("<a href=\"" + url + "?page=" + (endPage + 1) + "&" + param + "\">다음</a>");
    }
